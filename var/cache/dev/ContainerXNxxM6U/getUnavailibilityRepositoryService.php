...
// Returns the private 'App\Repository\UnavailibilityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UnavailibilityRepository.php';

return $this->privates['App\\Repository\\UnavailibilityRepository'] = new \App\Repository\UnavailibilityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
